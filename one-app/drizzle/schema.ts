...
/**
 * Kernel proposed decisions — the four possible outcomes.
 ...
 */
export const KERNEL_DECISIONS = ["AUTO_APPROVE", "REQUIRE_HUMAN", "DENY", "CLARIFY"] as const;
...
export interface KernelDecisionPayload {
  ...
  timestamp: string;
  trace_id: string;
  /** PATCH: Ambiguity Handling — present when proposed_decision is CLARIFY */
  clarification?: {
    reason: string[];
    missing_fields: string[];
    confidence_signals_available: Record<string, boolean>;
