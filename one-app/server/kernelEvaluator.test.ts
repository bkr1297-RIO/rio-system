...
function makeProposal(overrides?: Partial<ProposalPayload>): ProposalPayload {
  return {
    ...
    proposal: {
      destination: "partner_outreach_system",
      resource: "partnership_email",
      scope: "partnership_inquiry",
      action_type: "send_outreach",
      deadline: "2026-04-30",
      context: "Pattern match with similar outreach",
    ...
    const result = evaluateProposal(makeContext({
      proposal: makeProposal({
        ...
        proposal: {
          ...
          deadline: "2026-04-30",
          context: "Constraint violation test",
          amount: 10000,
          subject: "Big purchase",
        },
      }),
      trustPolicy: makePolicy({
        trustLevel: 2,
